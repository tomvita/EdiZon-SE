...
void GuiMemoryEditor::onTouch(HidTouchState &touch) {
...
void GuiMemoryEditor::onGesture(HidTouchScreenState startPosition, HidTouchScreenState endPosition, bool finish) {
